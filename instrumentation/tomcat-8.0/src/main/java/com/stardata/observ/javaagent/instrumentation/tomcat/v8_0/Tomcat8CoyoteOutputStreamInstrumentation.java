...
public class Tomcat8CoyoteOutputStreamInstrumentation implements TypeInstrumentation {
    ...
    public void transform(TypeTransformer transformer) {
        transformer.applyAdviceToMethod(
                isMethod()
                        .and(isPublic())
                        .and(named("write")),
                this.getClass().getName() + "$TomcatCoyoteOutputStreamAdvice");
    }

    public static class TomcatCoyoteOutputStreamAdvice {
