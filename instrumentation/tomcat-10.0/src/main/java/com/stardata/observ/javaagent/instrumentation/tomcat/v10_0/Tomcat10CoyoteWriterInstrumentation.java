...
public class Tomcat10CoyoteWriterInstrumentation implements TypeInstrumentation {
    ...
    public void transform(TypeTransformer transformer) {
        transformer.applyAdviceToMethod(
                isMethod()
                        .and(isPublic())
                        .and(named("write")),
                this.getClass().getName() + "$Tomcat10CoyoteWriterAdvice");
    }

    public static class Tomcat10CoyoteWriterAdvice {
        ...
        public static void onEnter(
            ...
            if (!(args[0] instanceof Integer) && args.length != 3) {
                // skip write(String) and write(char[])
                return;
            }
